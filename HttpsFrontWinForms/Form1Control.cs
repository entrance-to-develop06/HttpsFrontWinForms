...
using HttpsFrontWinForms.Model.AppService;
using HttpsFrontWinForms.Model.AppService.Dto;
using System.Net;
...
namespace HttpsFrontWinForms
{
    ...
    public partial class Form1Control : Form
    {
        ...
        public Form1Control(IHttpClientFactory factory)
        {
            ...
            service = new ShohinAppService(httpClient);
        }
        ...
        private async void ButtonRead_Click(object sender, EventArgs e)
        {
            ...
            {
                var list = JsonSerializer.Deserialize<List<ShohinDto>>(service.LastBody)!;
        ...
        private async void ButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            var remarks = fDesign.TextBoxRemarks.Text;
